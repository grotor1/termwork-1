    ...
    <div class="content">
      <section class="recent-posts">
        <div class="labeled-field">
          <div class="labeled-field__label">Персонажи</div>
          ...
          <div class="anime-list">
              <#list characters as el>
                <a class="list__item" href="character?id=${el["id"]}">
            ...
            <@comp.pagination pageCount=pageCount curPage=curPage url="characters" query=query/>
        </div>
      </section>
    </div>
  </main>
